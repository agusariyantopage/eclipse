...
<table style="width:100%;">    
    <tr>
        ...
        <td style="width:15%;">Akun</td>
        <td style="width:25%;">: KAS TOKO</td>
    </tr>
</table>
<br><br>
...
$grandtotal=0;
$sql_biaya = "SELECT akun_jurnal.id_akun_jurnal,tanggal_transaksi,deskripsi,debet-kredit as total_transaksi from akun_mutasi,akun_jurnal,akun where akun_mutasi.id_akun_jurnal=akun_jurnal.id_akun_jurnal and akun_mutasi.id_akun=akun.id_akun and akun_mutasi.id_akun=$id_akun ORDER BY tanggal_transaksi";
